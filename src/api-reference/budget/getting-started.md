...
Once you have registered your application, read about the [Budget Category](budget-category.md), [Fiscal Year](fiscal-year.md), [Budget Tracking Field](cost-object.md), and [Budget Item Header](budget-header.md) endpoints.
